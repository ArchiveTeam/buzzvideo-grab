...
More information about the archiving project can be found on the ArchiveTeam wiki: [BuzzVideo](http://archiveteam.org/index.php?title=BuzzVideo)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "BuzzVideo" project in the Warrior interface.
...
Have an issue not listed here? Join us on IRC and ask! We can be found at hackint IRC [#buzzoff](https://webirc.hackint.org/#irc://irc.hackint.org/#buzzoff).
