...
LUA_SHA1 = get_hash(os.path.join(CWD, 'buzzvideo.lua'))
...
class WgetArgs(object):
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'user':
                wget_args.extend(['--warc-header', 'buzzvideo-user: '+item_value])
                wget_args.append('https://www.buzzvideo.com/user/'+item_value)
            elif item_type == 'video':
                wget_args.extend(['--warc-header', 'buzzvideo-video: '+item_value])
                wget_args.append('https://www.buzzvideo.com/article/i'+item_value)
            else:
...
project = Project(
    title='BuzzVideo',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/b/b9/Buzzvideo-icon.png" height="50px" title=""/>
        <h2>buzzvideo.com <span class="links"><a href="https://buzzvideo.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/buzzvideo/">Leaderboard</a></span></h2>
        <p>Archiving BuzzVideo.</p>
    '''
)
